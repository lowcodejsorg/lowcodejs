...
describe('E2E Table Field Remove From Trash Controller', () => {
  ...
  describe('PATCH /tables/:slug/fields/:_id/restore', () => {
    it('deve restaurar campo da lixeira com sucesso', async () => {
      ...
      const response = await supertest(kernel.server)
        .patch(`/tables/${table.slug}/fields/${field._id}/restore`)
        .set('Cookie', cookies);

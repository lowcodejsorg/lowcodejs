  ...
  async execute(payload: CloneTableUseCasePayload): Promise<Response> {
    try {
      ...
      const createPayload: TableCreatePayload = {
        ...
        viewTable: baseTable.viewTable,
        updateTable: baseTable.updateTable,
        createField: baseTable.createField,
        updateField: baseTable.updateField,
        removeField: baseTable.removeField,
        viewField: baseTable.viewField,
        createRow: baseTable.createRow,
        updateRow: baseTable.updateRow,
        removeRow: baseTable.removeRow,
        viewRow: baseTable.viewRow,
        collaborators: [],

...
import { RowTableShowDialog } from "./row-table-show-dialog";
...
export function ActionMenu({ row }: { row: Row }) {
  ...
  const showRowTableButtonRef = React.useRef<HTMLButtonElement>(null);
  ...
  return (
    <React.Fragment>
      <DropdownMenu dir="ltr" modal={false}>
        ...
        <RowTableShowDialog _id={row._id} ref={showRowTableButtonRef} />

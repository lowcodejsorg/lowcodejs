  ...
  return (
    <FormItem>
      <FormLabel className="data-[error=true]:text-destructive">
        {t("COLLECTION_SHEET_FIELD_ADMINISTRATOR_LABEL", "Administradores")}
      ...
      <FormControl>
        <SearchableSelect
          ...
          isMultiple
          placeholder={t("COLLECTION_SELECT_ADMINISTRATORS_PLACEHOLDER", "Select administrators") as string}
          maxDisplayItems={2}

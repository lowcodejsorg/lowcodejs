...
export function FieldCollectionType({
  defaultValue = [],
  required,
  disabled = false,
}: Props) {
    ...
    <FormField
      ...
      rules={{
        validate: (value) => {
          if (!value && required)
            return t(
              "COLLECTION_ROUTE_SHEET_INTERNAL_FIELD_TYPE_REQUIRED_ERROR",
              "Tipo é obrigatório"
            );
        ...
        return (
          <FormItem>
            <FormLabel className="data-[error=true]:text-destructive">
              {t("COLLECTION_ROUTE_SHEET_INTERNAL_FIELD_TYPE_LABEL", "Tipo")}{" "}
            ...
            <FormControl>
              <SimpleSelect
                ...
                placeholder={
                  t(
                    "COLLECTION_ROUTE_SHEET_INTERNAL_FIELD_TYPE_PLACEHOLDER",

---
title: Pagination
description: Paginacao com navegacao de paginas, links de proximo e anterior.
base: radix
component: true
---
...
Uma paginacao simples com apenas numeros de pagina.
...
Use apenas os botoes de anterior e proximo sem numeros de pagina. Isso e util para tabelas de dados com um seletor de linhas por pagina.
...
Por padrao, o component `<PaginationLink />` renderiza uma tag `<a />`.

Para usar o component `<Link />` do Next.js, faca as seguintes atualizacoes em `pagination.tsx`.
...
**Nota:** Estamos fazendo atualizacoes no cli para fazer isso automaticamente para voce.
...
Se voce esta atualizando de uma versao anterior do component `Pagination`, precisara aplicar as seguintes atualizacoes para adicionar a prop `text`:

<Steps>

<Step>Atualize `PaginationPrevious`.</Step>
...
<Step>Atualize `PaginationNext`.</Step>

---
title: Command
description: Menu de comando para busca e ações rápidas.
base: radix
component: true
links:
...
O component `<Command />` utiliza o component [`cmdk`](https://github.com/dip/cmdk) criado por [Dip](https://www.dip.org/).
...
Um menu de comando simples em um dialog.
...
Um menu de comando com grupos, ícones e separadores.
...
Menu de comando rolável com múltiplos itens.

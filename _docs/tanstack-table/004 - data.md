...
The `data` array that you pass to the table instance **_MUST_** have a "stable" reference in order to prevent bugs that cause infinite re-renders (especially in React).

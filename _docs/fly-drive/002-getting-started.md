...
npm i flydrive
Once installed, you can import the Disk class and the driver you want to use to manage files. To keep things simple, we will use the FSDriver in this guide.

...
S3Driver - The S3 driver can be used with AWS S3, Cloudflare R2 and the Digital Ocean Spaces.

GCSDriver - The GCS driver is used to manage files on Google Cloud Storage.

FSDriver - The FS driver keeps files on the local filesystem and uses the Node.js fs module under the hood.
...
Next steps
Read the getting started guide to install and use Drive.
Learn about the key concepts and design decisions of Drive.

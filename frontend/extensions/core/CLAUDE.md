...
| `tools`   | `generate-test-data`   | `tools/generate-test-data/index.tsx`   | Gerador de registros de teste em massa: combobox de tabela + quantidade + barra de progresso com polling (`/tools/generate-test-data`) |

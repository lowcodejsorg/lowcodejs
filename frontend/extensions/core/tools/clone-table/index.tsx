...
export default function CloneTableTool(): React.JSX.Element {
  ...
  return (
    <PageShell data-test-id="tool-clone-table">
      <PageShell.Header>
        <PageHeader title="Clonar Tabela" />
      </PageShell.Header>

      <PageShell.Content className="p-4">
        {permission.isLoading && <CloneTableSkeleton />}

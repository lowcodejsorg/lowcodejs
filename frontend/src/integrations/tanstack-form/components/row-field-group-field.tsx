...
export function RowFieldGroupField({
  field,
  disabled,
}: RowFieldGroupFieldProps): React.JSX.Element {
    ...
    case FIELD_TYPE.TEXT_SHORT:
      return (
        <MockFieldWrapper formField={mockFormField}>
          <RowTextField field={groupField} disabled={disabled} />
        </MockFieldWrapper>
      );
    case FIELD_TYPE.TEXT_LONG:
      return (
        <MockFieldWrapper formField={mockFormField}>
          <RowTextareaField field={groupField} disabled={disabled} />
        </MockFieldWrapper>
      );
    case FIELD_TYPE.DROPDOWN:
      return (
        <MockFieldWrapper formField={mockFormField}>
          <RowDropdownField field={groupField} disabled={disabled} />
        </MockFieldWrapper>
      );
    case FIELD_TYPE.DATE:
      return (
        <MockFieldWrapper formField={mockFormField}>
          <RowDateField field={groupField} disabled={disabled} />
        </MockFieldWrapper>
      );
    case FIELD_TYPE.FILE:
      return (
        <MockFieldWrapper formField={mockFormField}>
          <RowFileField field={groupField} disabled={disabled} />
        </MockFieldWrapper>
      );
    case FIELD_TYPE.RELATIONSHIP:
      return (
        <MockFieldWrapper formField={mockFormField}>
          <RowRelationshipField field={groupField} disabled={disabled} />
        </MockFieldWrapper>
      );
    case FIELD_TYPE.CATEGORY:
      return (
        <MockFieldWrapper formField={mockFormField}>
          <RowCategoryField field={groupField} disabled={disabled} />
        </MockFieldWrapper>
      );
    default:
      return null;

  ...
  return (
    <React.Fragment>
      <SheetHeader className="px-0">
        <SheetTitle>{isEdit ? 'Editar item' : 'Adicionar item'}</SheetTitle>
      </SheetHeader>
  ...
  for (const field of fields) {
    ...
    switch (field.type) {
      ...
      case E_FIELD_TYPE.CATEGORY: {
        ...
        payload[field.slug] = field.multiple ? arr : arr.slice(0, 1);
        break;
      }
      case E_FIELD_TYPE.DATE:
        payload[field.slug] = value || null;
      ...
      case E_FIELD_TYPE.FILE: {
        ...
        if (fileVal && fileVal.storages) {
          ...
          payload[field.slug] = field.multiple ? ids : ids.slice(0, 1);
        } else {
          payload[field.slug] = [];
        }
        break;
      ...
      case E_FIELD_TYPE.USER: {
        ...
        const ids = opts.map((o: any) =>
          typeof o === 'object' && o !== null ? (o.value ?? o._id) : o,
        );
        payload[field.slug] = field.multiple ? ids : ids.slice(0, 1);
        break;
      }

...
interface Props {
  placeholder?: string;
  selectedValues: Array<SearchableOption>;
  onChange: (values: Array<SearchableOption>) => void;
  isMultiple?: boolean;
...
export function SearchableSelect({
  ...
  const renderOptions = () => {
    ...
    const selectedOptions: Array<SearchableOption> = [];
    const unselectedOptions: Array<SearchableOption> = [];

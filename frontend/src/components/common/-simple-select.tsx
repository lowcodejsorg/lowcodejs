...
interface SimpleSelectProps {
  placeholder?: string;
  selectedValues: Array<SelectOption>;
...
export function SimpleSelect({
  ...
  const groupedOptions = options.reduce<Record<string, Array<SelectOption>>>(
    (groups, option) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <DropdownMenuContent
          className="w-full min-w-60 p-0"
          align="start"
          onCloseAutoFocus={(e) => e.preventDefault()}
        >
          <div className="max-h-75 overflow-y-auto overflow-x-hidden scroll-smooth">
            {options.length === 0 && (

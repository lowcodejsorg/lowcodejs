        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              {t("SYSTEM_ROUTE_LOGO_SETTINGS_TITLE", "Logo Settings")}
            </CardTitle>
            <CardDescription>
              {t(
                "SYSTEM_ROUTE_LOGO_SETTINGS_DESCRIPTION",
                "Configure system logos and branding"
              )}
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Uploader
                ...
                fieldName="LOGO_SMALL_URL"
                label={
                  t(
                    "SYSTEM_ROUTE_LOGO_SMALL_URL_LABEL",
                    "Logo Pequeno"
                  ) as string
                }
                defaultValue={setting.LOGO_SMALL_URL ? [setting.LOGO_SMALL_URL] : []}
                placeholder={
                  t(
                    "SYSTEM_ROUTE_LOGO_SMALL_URL_PLACEHOLDER",
                    "Arraste ou selecione o logo pequeno"
                  ) as string
                }
              />
              ...
              <Uploader
                ...
                fieldName="LOGO_LARGE_URL"
                label={
                  t(
                    "SYSTEM_ROUTE_LOGO_LARGE_URL_LABEL",
                    "Logo Grande"
                  ) as string
                }
                defaultValue={setting.LOGO_LARGE_URL ? [setting.LOGO_LARGE_URL] : []}
                placeholder={
                  t(
                    "SYSTEM_ROUTE_LOGO_LARGE_URL_PLACEHOLDER",
                    "Arraste ou selecione o logo grande"
                  ) as string
                }
              />
            </div>

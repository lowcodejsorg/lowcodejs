...
Todos os campos vivem no documento Setting do MongoDB. O backend aplica
defaults no schema Mongoose — nenhum campo depende mais de variaveis de
ambiente (apenas `STORAGE_DRIVER` e credenciais S3 permanecem no .env).

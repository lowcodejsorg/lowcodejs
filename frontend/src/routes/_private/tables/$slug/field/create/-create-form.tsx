  ...
  render: function Render({
    ...
    return (
      <section className="space-y-4 p-2">
        ...
        {/* Campo Listagem - Desabilitado por enquanto a solicitação para desabalitar
        foi solicitada em 21/03/2026 pois não fazia mas sentido para o que temos hoje, e sera analisado se vai continuar ou não. */}

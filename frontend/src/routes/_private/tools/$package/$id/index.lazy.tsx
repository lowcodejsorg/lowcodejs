...
export const Route = createLazyFileRoute('/_private/tools/$package/$id/')({
  component: RouteComponent,
});

function ToolLoadingState(): React.JSX.Element {
  return (
    <PageShell>
      <PageShell.Header>
        <PageHeader title="Carregando ferramenta..." />
      </PageShell.Header>

...
| `constant.ts`              | Enums do dominio (`E_FIELD_TYPE`, `E_FIELD_FORMAT`, `E_ROLE`, `E_TABLE_STYLE`, `E_TABLE_PERMISSION`, etc.), arrays de options para selects, mappers de labels, regex de validacao, eventos de chat Socket.IO                                                                                                                                                                                                                                                                              |

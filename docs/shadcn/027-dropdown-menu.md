---
title: Dropdown Menu
description: Exibe um menu para o usuario — como um conjunto de acoes ou funcoes — acionado por um botao.
featured: true
base: radix
component: true
links:
...
Um dropdown menu basico com labels e separadores.
...
Use `DropdownMenuSub` para aninhar acoes secundarias.
...
Adicione `DropdownMenuShortcut` para mostrar dicas de teclado.
...
Combine icones com labels para uma leitura rapida.
...
Use `DropdownMenuCheckboxItem` para opcoes de alternancia.
...
Adicione icones aos itens de checkbox.
...
Exiba opcoes de radio com icones.
...
Use `variant="destructive"` para acoes irreversiveis.
...
Um alternador de conta acionado por um avatar.
...
Um exemplo mais rico combinando grupos, icones e submenus.
...
Consulte a [documentacao do Radix UI](https://www.radix-ui.com/docs/primitives/components/dropdown-menu) para a referencia completa da API.

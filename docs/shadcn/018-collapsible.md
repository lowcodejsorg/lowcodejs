---
title: Collapsible
description: Um component interativo que expande/recolhe um painel.
base: radix
component: true
featured: true
links:
...
Use as props `open` e `onOpenChange` para controlar o state.
...
Use um botao de gatilho para revelar configuracoes adicionais.
...
Use collapsibles aninhados para construir uma arvore de arquivos.

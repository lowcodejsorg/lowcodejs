...
Para usar roteamento baseado em arquivos com o **Webpack**, você precisará instalar o pacote `@tanstack/router-plugin`.
...
Ou você pode clonar nosso [exemplo Quickstart com Webpack](https://github.com/TanStack/router/tree/main/examples/react/quickstart-webpack-file-based) e começar.

Agora que você adicionou o plugin à sua configuração do Webpack, está tudo pronto para começar a usar roteamento baseado em arquivos com o TanStack Router.
...
Ao usar o Plugin do TanStack Router com Webpack para roteamento baseado em arquivos, ele vem com alguns padrões sensatos que devem funcionar para a maioria dos projetos:

...
Em algumas situações, você pode querer focar o primeiro input com erro.

[Como o TanStack Form intencionalmente não tem visibilidade sobre sua marcação](../../../philosophy.md), não podemos adicionar um recurso de gerenciamento de foco embutido.

No entanto, você pode facilmente adicionar esse recurso na sua aplicação sem essa funcionalidade hipotética embutida.
...
Como o React Native não tem acesso à API `querySelectorAll` do DOM, precisamos gerenciar manualmente a lista de elementos
dos inputs. Isso nos permite focar o primeiro input com erro:

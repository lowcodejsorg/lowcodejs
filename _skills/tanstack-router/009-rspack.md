...
Para usar roteamento baseado em arquivos com o **Rspack** ou **Rsbuild**, você precisará instalar o pacote `@tanstack/router-plugin`.
...
Ou você pode clonar nosso [exemplo Quickstart com Rspack/Rsbuild](https://github.com/TanStack/router/tree/main/examples/react/quickstart-rspack-file-based) e começar.

Agora que você adicionou o plugin à sua configuração do Rspack/Rsbuild, está tudo pronto para começar a usar roteamento baseado em arquivos com o TanStack Router.
...
Ao usar o Plugin do TanStack Router com Rspack (ou Rsbuild) para roteamento baseado em arquivos, ele vem com alguns padrões sensatos que devem funcionar para a maioria dos projetos:

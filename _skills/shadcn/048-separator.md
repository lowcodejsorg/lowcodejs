...
Use `orientation="vertical"` para um separador vertical.
...
Separadores verticais entre itens de menu com descrições.
...
Separadores horizontais entre itens de lista.

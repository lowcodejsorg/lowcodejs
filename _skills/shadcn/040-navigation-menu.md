...
description: Uma colecao de links para navegacao em sites.
base: radix
component: true
links:
...
Use a prop `asChild` para compor um component de link personalizado como o `Link` do Next.js.
...
Consulte a documentacao do [Radix UI Navigation Menu](https://www.radix-ui.com/docs/primitives/components/navigation-menu#api-reference) para mais informacoes.

---
title: Scroll Area
description: Aprimora a funcionalidade nativa de scroll para estilização customizada e compatível entre navegadores.
base: radix
component: true
links:
...
Use `ScrollBar` com `orientation="horizontal"` para scroll horizontal.
